...
import com.ping.homeschool.dao.PermissionDao;
import com.ping.homeschool.service.PermissionService;
...
public class PermissionServiceImpl implements PermissionService {
	...
	private JSONObject getUserPermissionFromDB(String username) {
		...
		// 输出 userPermission，方便调试
		System.out.println("User Permission: " +username+ userPermission.toJSONString());
		//管理员角色ID为3
		int adminRoleId = 1;
		//如果是管理员
